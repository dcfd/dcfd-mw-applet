...
package test.unit.be.fedict.eid.idp.wstrust;
...
public class SecurityTokenServiceFactoryTest {
	...
	public void testGetInstance() {
		// operate
		SecurityTokenService testedInstance = SecurityTokenServiceFactory
				.getInstance();
		...
		// operate
		SecurityTokenServicePort port = testedInstance
				.getSecurityTokenServicePort();
