...
public class TestUtils {
	...
	public static X509Certificate generateSelfSignedCertificate(
		...
		return generateSelfSignedCertificate(keyPair, dn, notBefore, future,
	...
	public static X509Certificate generateSelfSignedCertificate(
		...
		return generateCertificate(keyPair.getPublic(), dn,
				keyPair.getPrivate(), null, notBefore, notAfter,
	...
	public static X509Certificate generateCertificate(
		...
		return generateCertificate(subjectPublicKey, subjectDn,
				issuerPrivateKey, issuerCert, notBefore, notAfter,
				signatureAlgorithm, includeAuthorityKeyIdentifier, caCert,
				timeStampingPurpose, ocspUri, crlUri, keyUsage, new BigInteger(
	...
	public static X509Certificate generateCertificate(
			...
			boolean includeAuthorityKeyIdentifier, boolean caCert,
			boolean timeStampingPurpose, String ocspUri, String crlUri,
			KeyUsage keyUsage, BigInteger serialNumber) throws IOException,
	...
	public static X509V2CRLGenerator getCrlGenerator(int crlNumber,
	...
	public static X509CRL generateCrl(int crlNumber,
			PrivateKey issuerPrivateKey, X509Certificate issuerCertificate,
		...
		X509V2CRLGenerator crlGenerator = getCrlGenerator(crlNumber,
				issuerCertificate, thisUpdate, nextUpdate,
